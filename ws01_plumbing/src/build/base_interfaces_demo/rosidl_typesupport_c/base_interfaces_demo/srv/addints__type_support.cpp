...
static const _Addints_Request_type_support_symbol_names_t _Addints_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, base_interfaces_demo, srv, Addints_Request)),
...
static const _Addints_Response_type_support_symbol_names_t _Addints_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_c, base_interfaces_demo, srv, Addints_Response)),
...
static const _Addints_type_support_symbol_names_t _Addints_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_c, base_interfaces_demo, srv, Addints)),
