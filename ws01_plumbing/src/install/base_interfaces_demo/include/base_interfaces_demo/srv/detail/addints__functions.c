  ...
  base_interfaces_demo__srv__Addints_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    base_interfaces_demo__srv__Addints_Request * data =
      (base_interfaces_demo__srv__Addints_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!base_interfaces_demo__srv__Addints_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          base_interfaces_demo__srv__Addints_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  base_interfaces_demo__srv__Addints_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    base_interfaces_demo__srv__Addints_Response * data =
      (base_interfaces_demo__srv__Addints_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!base_interfaces_demo__srv__Addints_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          base_interfaces_demo__srv__Addints_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
